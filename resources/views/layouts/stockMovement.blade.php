    ...
    <aside class="w-full md:w-64 bg-navy text-white flex flex-col justify-between md:sticky md:top-0 md:h-screen shadow-xl z-20 shrink-0">
        <div class="flex flex-col">
            ...
            <nav class="p-4 flex flex-col gap-1.5 overflow-y-auto">
                ...
                <a href="{{ route('stock-movements.index') }}" class="px-4 py-2.5 text-xs font-bold text-white bg-white/10 border-l-4 border-emeraldAccent rounded-r-lg transition-all">Stock Movements</a>
