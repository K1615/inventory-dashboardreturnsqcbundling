### inventory-warehouselayout remote repo

- Clone niyo lang itong repo sa laragon/www ninyo.
- Pagkaclone, punta kayo laragon, open niyo server, open niyo terminal, navigate kayo papuntang folder neto - cd inventory-dashboardreturnsqcbundling
...
DB_HOST=127.0.0.1  
DB_PORT=3306  
DB_DATABASE="inventory-dashboardreturnsqcbundling"  
DB_USERNAME=root  
DB_PASSWORD=  
